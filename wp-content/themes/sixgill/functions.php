<?php
	...
	function sixgill_custom_stylesheets() {
		if ( ! is_admin() ) {
			wp_enqueue_style( 'sixgill_custom_styles', get_template_directory_uri() . '/custom_build.css', array(), "08092016");
		}
	}
	...
	function sixgill_custom_scripts() {
		if ( ! is_admin() ) {
			wp_enqueue_script( 'sixgill_custom_scripts', get_template_directory_uri() . '/custom_build.js', array(), "08092016");
		}
	}
