<?php
	...
	function sixgill_custom_stylesheets() {
		if ( ! is_admin() ) {
			wp_enqueue_style( 'sixgill_custom_styles', get_template_directory_uri() . '/css/custom_build.css', array(), "22082016");
		}
	}
	...
	function sixgill_custom_scripts() {
		if ( ! is_admin() ) {
			wp_enqueue_script( 'sixgill_custom_scripts', get_template_directory_uri() . '/js/custom_build.js', array(), "22082016");
		}
	}
