...
<div class="full-width ohidden full-page-wrapper"> <!-- fullpage wrapper placeholder -->
	...
	<div
		...
		<?php
			$blueFilterFlag = get_field('blue_filter', false, false);
		...
		?>
		>
		<div class="blog-page-header-filter <?php echo $blueFilterFlag == '1' ? '' : 'hide'?>"></div>
				...
				<div class="blog-page-post-card">
					...
					<div class="blog-page-post-card-content-wrapper">
						...
						<div class="blog-page-post-card-author-date">
							Post by <?php echo get_field('author'); ?> | <?php the_time('m/d/Y'); ?>
						</div>
