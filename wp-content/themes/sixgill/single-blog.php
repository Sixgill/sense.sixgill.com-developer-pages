		...
		<div id="single-page-content" class="container-fluid clearfix nomargin nopadding" style="background-color:#FFF;">
					...
					<tr style="text-align: center;">
						<td style="width: 25%; height: 60px;">
							<a href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>" target="_blank" title="Share on Facebook.">
								<img src="/wp-content/themes/sixgill/images/td/blog/facebook_normal.svg" alt="Mountain View" id="image-mobile-fecebook-share" class="shareButton-mobile">
							</a>
						</td>
						<td style="width: 25%; height: 60px;">
							<a href="http://twitter.com/home/?status=<?php the_title(); ?> - <?php the_permalink(); ?>" target="_blank" title="Tweet this!">
								<img src="/wp-content/themes/sixgill/images/td/blog/twitter_normal.svg" alt="Mountain View" id="image-mobile-twitter-share" class="shareButton-mobile">
							</a>
						</td>
						<td style="width: 25%; height: 60px;">
							<a href="http://www.linkedin.com/shareArticle?mini=true&amp;title=<?php the_title(); ?>&amp;url=<?php the_permalink(); ?>" target="_blank" title="Share on LinkedIn">
								<img src="/wp-content/themes/sixgill/images/td/blog/linkedin_normal.svg" alt="Mountain View"  id="image-mobile-linkedin-share" class="shareButton-mobile">
							</a>
						</td>
						<td style="width: 25%; height: 60px;">
			...
			<div id="aside1">
				<ul class="marginShareButton">
					...
					<a href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>" target="_blank" title="Share on Facebook.">
						<img src="/wp-content/themes/sixgill/images/td/blog/facebook_normal.svg" alt="Mountain View" id="image-fecebook-share" class="shareButton">
					</a>
					<li>
						<a href="http://twitter.com/home/?status=<?php the_title(); ?> - <?php the_permalink(); ?>" target="_blank" title="Tweet this!">
							<img src="/wp-content/themes/sixgill/images/td/blog/twitter_normal.svg" alt="Mountain View" id="image-twitter-share" class="shareButton">
						</a>
					</li>
					<li>
						<a href="http://www.linkedin.com/shareArticle?mini=true&amp;title=<?php the_title(); ?>&amp;url=<?php the_permalink(); ?>" target="_blank" title="Share on LinkedIn">
