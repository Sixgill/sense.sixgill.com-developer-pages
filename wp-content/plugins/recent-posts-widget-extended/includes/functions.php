...
function rpwe_get_recent_posts( $args = array() ) {
    ...
    $html .= '<h3 style="font-size: 14px; font-weight: bold;"><a href="' . esc_url( get_permalink() ) . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'recent-posts-widget-extended' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark" class="press-post-title">' . esc_attr( get_the_title() ) . '</a></h3>';
